    ...
    public class MainWindow : Window
    {
        public MainWindow()
        {
            ...
            */
            ...
            List<Color> barva = new List<Color> { Colors.Yellow, Colors.GreenYellow, Colors.LightGoldenrodYellow, Colors.LightYellow };
            for (int i = 0; i < random.Next(200, 800); i++)
            {
                foxDraw.SetStrokeColor(barva[random.Next(0, 3)]);
